        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-blue-600">{activeVisitors}</span>
                    ...
                    <Badge 
                      ...
                      className="w-fit"
                    >
                      {activeVisitors > 0 ? "Currently active" : "No active visitors"}
                    </Badge>
                  </div>
                </CardContent>
              </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-orange-600">{pendingAlerts}</span>
                ...
                {dashboardLabels.map((label) => (
                  <Card 
                    ...
                    className={`cursor-pointer transition-all hover:shadow-md ${
                      selectedLabelId === label.id ? 'ring-2 ring-primary bg-primary/5' : ''
                    }`}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {label.lastSendTimestamp && (
                            <span className="text-xs text-muted-foreground">
                              Last: {formatLastSendTime(new Date(label.lastSendTimestamp))}
                            </span>
                          )}
                        </div>
                      </div>
        ...
        <Card className="border-2 border-primary/20">
          ...
          <CardContent>
            {isLoading ? (
              ...
              {/* Alert Message Input */}
              <div className="space-y-2">
                <label htmlFor="dashboard-alert-message" className="text-sm font-medium text-gray-700">
                  Alert Message
                </label>
                <textarea
